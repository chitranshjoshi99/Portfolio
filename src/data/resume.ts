    ...
    achievements: [
      {
        ...
        metric: "4.2s → 1.1s",
        text: "Pagination & query optimisation on 10k+ monthly transactions",
      },
      {
        label: "GraphQL Queries",
        metric: "–70%",
        text: "Cursor-based pagination eliminating timeouts on 50k-row datasets",
      },
      {
        label: "P95 API Latency",
        metric: "800ms → 120ms",
        text: "Composite indexes on 5M+ row order/shipment tables",
      },
      {
        label: "Processing Errors",
        metric: "–40%",
        text: "Barcode-scan shipment platform for international diamond logistics",
      },
      {
        label: "Render Perf",
        metric: "+45%",
        text: "Virtualised lists & memoisation on delivery hub dashboards",
      },
      {
        label: "TypeScript Bugs",
        metric: "–25%",
        text: "Led monorepo-wide TypeScript migration with typed API adoption",
      },
      {
        label: "AI Tooling",
        metric: "Day-1 adopter",
        text: "Built custom Claude Code skills to automate code reviews team-wide",
      },
    ],
    tags: [
      "React",
    ...
    achievements: [
      {
        ...
        metric: "–40%",
        text: "Decoupled services for independent versioning & rollbacks",
      },
      {
        label: "JS Bundle",
        metric: "–42%",
        text: "Code-splitting, lazy loading & memoisation on logistics dashboards",
      },
      {
        label: "Maps Cost",
        metric: "–35%",
        text: "Tier-based Google / OSM / MapMyIndia / HereMaps dynamic switching",
      },
      {
        label: "Test Coverage",
        metric: "70%+",
        text: "Jest + RTL suites across 5 modular apps, –30% regression defects",
      },
      {
        label: "Exception Response",
        metric: "–50%",
        text: "WebSocket live tracking for 10k+ active daily shipments",
      },
      {
        label: "A11y Score",
        metric: "62 → 94",
    ...
    achievements: [
      {
        ...
        metric: "–40%",
        text: "Custom HLS.js ABR player with dynamic rendition switching",
      },
      {
        label: "Video Abandonment",
        metric: "–28%",
        text: "Tiered MEDIA/NETWORK error recovery with exponential backoff",
      },
      {
        label: "Live Classes",
        metric: "200–500",
        text: "Concurrent viewers via 100ms WebRTC SDK with reconnection logic",
      },
      {
        label: "Vendor Onboarding",
        metric: "–35%",
        text: "Server-driven UI campaigns configurable from a non-tech dashboard",
      },
      {
